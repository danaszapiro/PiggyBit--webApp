 ...
 */
public class CoinbaseAccessTokenErrorResponse extends OAuthException {
	...
	public CoinbaseAccessTokenErrorResponse(String message, String type, String code, String fbtraceId,
			String rawResponse) {
		super(message);
		this.type = type;
		this.code = code;
	...
	public boolean equals(Object obj) {
		...
		final CoinbaseAccessTokenErrorResponse other = (CoinbaseAccessTokenErrorResponse) obj;
	...
	public String toString() {
		return "CoinbaseAccessTokenErrorResponse{'type'='" + type + "', 'code'='" + code + "', 'fbtraceId'='"
				+ fbtraceId + "', 'rawResponse'='" + rawResponse + "', 'message'='" + getMessage() + "'}";
	}
}