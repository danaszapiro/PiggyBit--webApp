...
public class CoinbaseService extends OAuth20Service {

	public CoinbaseService(DefaultApi20 api, OAuthConfig config) {
		super(api, config);
	}
	...
	public void signRequest(String accessToken, OAuthRequest request) {
		...
		try {
			...
			throw new IllegalStateException("There is a problem while generating Coinbase appsecret_proof.", e);
		}
	}
}